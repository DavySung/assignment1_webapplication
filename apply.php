...
<head>
  ...
  <script
   src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcA0SyKYWw6BktAG3w-gWV-LzOHY_uILg&libraries=places"></script>
<!-- <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyCcA0SyKYWw6BktAG3w-gWV-LzOHY_uILg&callback=initMap" async defer></script> -->
